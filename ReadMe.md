...
## Segmentation Schemes:
    -Canny and Canny Filled: The Canny part will use the Canny
    ...
    -ICM and K-Mean: This method presupposes a statistical distribution in the
    ...
    -Filling and Filling f: This method takes a seed as a starting point.
    ...
    -Ellipsoid: This creates an ellipsoid with a given center with the specified lengths for each axis.
    -Threshold: This takes an already determined segmentation and will only keep all the voxels that
...
Error Bar Schemes:
    -Linear Shift: This will take a given segmentation and shift it by
